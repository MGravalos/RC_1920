...
menores_o_iguales([],_,[]).
menores_o_iguales([C|Resto],E,[C|R]):- C=<E,menores_o_iguales(Resto,E,R).
menores_o_iguales([C|Resto],E,R) :- C> E,menores_o_iguales(Resto,E,R).
...
mayores([],_,[]).
mayores([C|Resto],E,[C|R]):-C>E,mayores(Resto,E,R).
mayores([C|Resto],E,R) :- C=<E, mayores(Resto,E,R).
